package main.java.ma.emsi.mvc.controllers.secretaireModule.api;
...
public interface SecretairePatientController {
     ...
     */
    ResponseWrapper<PageResponse<PatientResponse>> getPatients = null;
    void Page(int page, int pageSize);

    ResponseWrapper<PageResponse<PatientResponse>> getPatientsPage(int page, int pageSize);
}
